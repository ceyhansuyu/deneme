...
/*
 *      parser.php - Simple Bad Parser: a parser BBcode to/from html
 *      
...
/**
 * Parser BBcode to/from HTML (XHTML transitional 1.0)
 * 
 * @version 0.1
 * @author Emilio Coppa <ercoppa@gmail.com>
 * @copyright Copyright (c) 2008 by Emilio Coppa released under the terms of GPL-2
 * @license http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
 * @package BSP - Bad Simple Parser
 * @filesource
 */
	...
	function bb_to_html($text){
		...
		if ( !$this->restrict ){
			...
			$replace = array('<span style="color: $1">$2</span>',
							 ...
							 '<div class="quotetopla"><div class="quotetitle">ALINTI</div><div class="quotecontent"><i>$2</i></div></div>',
							 '<div class="quotetopla"><div class="quotetitle">$1 Yazmýþ</div><div class="quotecontent">$3</div></div>',
							 '<a href="mailto: $1">$1</a>',
							 '<a href="$1">$1</a>',
							 '<a href="mailto: $1">$2</a>',
							 '<a href="$1">$2</a>',
							 ...
							 '<img src="$1" alt="$1" />',
							 '<img src="$1" alt="$2" />',
							 '<div class="codetopla"><div class="codetitle">KOD:</div><div class="codecontent">$2</div></div>',
							 '<div class="codetopla"><div class="codetitle">PHP:</div><div class="codecontent">$2</div></div>',
