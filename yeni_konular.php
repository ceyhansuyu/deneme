...
//SAYFA DETAYLARI
    $baslik= "Yeni Konular";
	$sayfa_url ="yeni_konular.php";
	$menu = '<a href="index.php">Anasayfa</a> > <a href="yeni_konular.php">Yeni Konular</a>';
	// Kullanýcý koordinat
...
// Yeni koular son 24 saat içindeki aktif konular
$birsaat = 60*60;
$yirmi4saat = time() - ($birsaat *24);
...
///////////////////////// SAYFALAMA BAÞLADI ///////////	
	...
	//misafir deðilse
	if(!empty($_SESSION['misafir_ilk_giris']))
	{
		$SQLCEK = "SELECT * FROM konular WHERE  son_mesaj_zamani >'".$yirmi4saat."' order by  son_mesaj_zamani desc";
	}
	//Üye ise
	else
	{
...
$template->set_filenames(array('yeni_konular' => 'yeni_konular.html' ));

$template->display('yeni_konular');
